  ...
  return (
    <div className="relative w-full sm:w-auto" ref={dropdownRef}>
      ...
      <button
        ...
        className="inline-flex items-center justify-between px-3 py-2 w-full sm:w-56 h-10 bg-white border border-gray-300 rounded-lg hover:bg-gray-50 focus:outline-none focus:ring-1 focus:ring-blue-500 text-xs sm:text-sm"
      >
      ...
      {/* Dropdown content */}
      {isOpen && (
        <div className="absolute z-10 mt-1 w-screen sm:w-80 left-0 sm:left-auto right-0 sm:right-auto bg-white border border-gray-200 rounded-lg shadow-xl p-4">
