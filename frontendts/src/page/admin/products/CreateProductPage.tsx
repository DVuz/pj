...
import { useProductForm } from '@/hooks/product/useProductForm.tsx';
...
const CreateProductPage: React.FC = () => {
  ...
  // Fetch danh sách product types (chỉ lấy active, không phân trang)
  const { data: productTypesData, isLoading: isLoadingProductTypes } = useGetProductTypesQuery({
    status: 'active',
    limit: 100, // Lấy nhiều để hiển thị đầy đủ
  });

  // Chuyển đổi product types thành options cho Select
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-4">
          ...
          <p className="text-sm text-gray-600 mt-1">
            Điền đầy đủ thông tin bên dưới để tạo sản phẩm mới
          </p>
        </div>
              ...
              <div className="bg-white rounded-lg shadow-sm p-4 border border-gray-200">
                <div className="flex gap-3">
                  ...
                  <Button
                    ...
                    className="flex-1"
                  >
                    {isLoading ? <Loading type="inline" text="Đang tạo..." /> : 'Tạo sản phẩm'}
                  </Button>
                </div>
              </div>
            </div>
